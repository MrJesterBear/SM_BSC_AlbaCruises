...
VALUES
-- route 1 = Mallaig -> Eigg -> Muck
-- Route 2 = Muck -> Eigg -> Mallaig
(1, 1, 2, "Mallaig - Eigg"),
(1, 2, 4, "Eigg - Muck"),
...
-- Route 3 = Mallaig -> Eigg -> Rum
-- Route 4 = Rum -> Eigg -. Mallaig
(3, 1, 2, "Mallaig - Eigg"),
(3, 2, 3, "Eigg - Rum"),
...
(1, "2024-05-13", "2024-10-18", "12:30:00", "13:30:00", 30, "Monday,Wednesday,Friday"),
(2, "2024-05-13", "2024-10-18", "15:30:00", "16:00:00", 30, "Monday,Wednesday,Friday"),
(2, "2024-05-13", "2024-10-18", "16:30:00", "17:30:00", 30, "Monday,Wednesday,Friday"),

-- Sundays 
(1, "2024-06-01", "2024-08-31", "11:00:00", "12:00:00", 30, "Sunday"),
(1, "2024-06-01", "2024-08-31", "12:30:00", "13:30:00", 30, "Sunday"),
(2, "2024-06-01", "2024-08-31", "15:30:00", "16:00:00", 30, "Sunday"),
(2, "2024-06-01", "2024-08-31", "16:30:00", "17:30:00", 30, "Sunday"),

-- Tuesday and Saturday is the same, but saturday is different dates.
(3, "2024-05-13", "2024-10-18", "11:00:00", "12:00:00", 30, "Tuesday"),
(3, "2024-05-13", "2024-10-18", "12:30:00", "13:30:00", 30, "Tuesday"),
(4, "2024-05-13", "2024-10-18", "15:30:00", "16:00:00", 30, "Tuesday"),
(4, "2024-05-13", "2024-10-18", "16:30:00", "17:30:00", 30, "Tuesday"),

-- Saturdays
(3, "2024-06-01", "2024-08-31", "11:00:00", "12:00:00", 30, "Saturday"),
(3, "2024-06-01", "2024-08-31", "12:30:00", "13:30:00", 30, "Saturday"),
(4, "2024-06-01", "2024-08-31", "15:30:00", "16:00:00", 30, "Saturday"),
(4, "2024-06-01", "2024-08-31", "16:30:00", "17:30:00", 30, "Saturday"),

-- Thursdays has it's own special timetable.
(5, "2024-05-13","2024-10-18", "11:00:00", "12:45:00", 30, "Thursday"),
(6, "2024-05-13","2024-10-18", "15:45:00", "17:30:00", 30, "Thursday" );
...
SELECT 
	...
	AlbaTimetable.routeID,
	AlbaTimetable.departureTime,
    AlbaTimetable.arivalTime,
    AlbaTimetable.seatOccupancy,
    AlbaTimetable.dayOfTravel
From AlbaTimetable
join AlbaRoutes
on AlbaTimetable.routeID = AlbaRoutes.routeID
join AlbaDestinations
on AlbaRoutes.callingID = AlbaDestinations.destinationID and AlbaRoutes.callingID = AlbaDestinations.destinationID
Where '2024-05-13' BETWEEN AlbaTimetable.timetableStart and AlbaTimetable.timetableEnd
and AlbaRoutes.destinationID = 4  -- AND AlbaRoutes.callingID = 1
and FIND_IN_SET("Monday", AlbaTimetable.dayOfTravel) > 0
group by AlbaRoutes.routeID;

-- Get the route details.
SELECT
	AlbaRoutes.routeID,
	AlbaDestinations.destinationName,
    AlbaRoutes.callingID,
    AlbaRoutes.destinationID,
    AlbaRoutes.routeDesc,
    AlbaTimetable.arivalTime
From AlbaRoutes
join AlbaTimetable
on AlbaRoutes.routeID = AlbaTimetable.routeID
join AlbaDestinations
on AlbaRoutes.destinationID = AlbaDestinations.destinationID
Where '2024-05-13' BETWEEN AlbaTimetable.timetableStart and AlbaTimetable.timetableEnd
and AlbaRoutes.destinationID = 4
and FIND_IN_SET("Monday", AlbaTimetable.dayOfTravel) > 0 ;